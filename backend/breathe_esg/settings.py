...
SECRET_KEY = os.environ.get('SECRET_KEY', 'dev-secret-key-change-in-production-abc123')
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1').split(',')
ALLOWED_HOSTS += ['.onrender.com', '.railway.app', '.fly.dev']
...
# Static files — WhiteNoise serves both Django admin assets and the built React app
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'
STATICFILES_DIRS = []

# After `npm run build`, copy frontend/dist here so Django can serve it
